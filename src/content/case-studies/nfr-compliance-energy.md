...
1. **Cyber security** — authentication, role-based access control, multi-factor authentication, data classification, encryption in transit and at rest, key management, vulnerability management, penetration testing, incident response, patching, network security, logging and monitoring, access reviews, SIEM integration, data-loss prevention, backup security, secure SDLC, third-party risk, GDPR / privacy, business continuity, security training, compliance reporting.
