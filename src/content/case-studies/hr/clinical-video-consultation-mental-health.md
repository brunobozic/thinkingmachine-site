...
quickRead: |
  EU pružatelj usluga mentalnog zdravlja trebao je self-hosted, EU-only platformu za video konzultacije koja bi (a) isporučila mjerljivo bolji signal za kanale koje kliničari zapravo koriste — mikro-izraze lica i glasovnu tonalnost — od onog što Zoom ili Teams pružaju pri istoj propusnosti, (b) tretirala face mesh podatke kao biometrijske podatke po GDPR članku 9, što oni i jesu, i (c) ostala podalje od visokorizične klasifikacije EU AI Acta za sustave prepoznavanja emocija.

  Organizacijsko načelo arhitekture: **"Klijent radi, server prosljeđuje"** — sav ML (ekstrakcija face mesha, smanjenje šuma, ROI kodiranje, adaptivna brzina sličica) izvršava se na klijentskom uređaju; server je inteligentni preklopnik. Rezultat: CPU servera ostaje ispod 15% čak i pri punom kapacitetu, marginalni trošak veće kvalitete je nula, a platforma isporučuje ~2,5× oštrije lice pri istoj ukupnoj propusnosti, 96 kbps Opus zvuk (3× Zoomov default), i ~50% smanjenje pohrane kroz kompozitno snimanje — kumulativno **smanjenje pohrane od 98% na cold-tieru** kroz cijelu kodek-+-kompozit-+-face-mesh-+-retencija cijev. €2.190/mjesec na €45–55/mjesec pri 500 sesija/dan.

  **Razlikovna arhitektonska odluka: namjerno *bez* prepoznavanja emocija.** EU AI Act (članak 5(1)(f)) zabranjuje prepoznavanje emocija u kontekstima rada i obrazovanja, ali ga dopušta za medicinske svrhe kroz usku iznimku. Odlučili smo ne koristiti medicinsku iznimku, oslanjajući se na meta-analizu Lise Feldman Barrett iz 2019. preko 1.000 studija koja pokazuje da izrazi lica ne omogućuju pouzdanu inferenciju emocija. Platforma mjeri *pokret*, ne emociju. Nula oznaka emocija, nula vrijednosti pouzdanosti, nula vremenskih grafova emocija. Sustav nikada ne kaže kliničaru što pacijent osjeća.

  Isporučeno kao arhitektonska specifikacija i odabir tehnologije — spremno za staged implementaciju, opravdano na razini koju regulator ili prijavljeno tijelo mogu auditirati.
