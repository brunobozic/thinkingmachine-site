...
quickRead: |
  **Najvažnija odluka u ovom angažmanu bila je odbijanje.** Akt EU-a o umjetnoj inteligenciji (članak 5. stavak 1. točka (f)) zabranjuje prepoznavanje emocija u radnom i obrazovnom kontekstu, ali ga izričito dopušta u medicinske svrhe. Odlučili smo *ne* koristiti medicinsku iznimku — oslanjajući se na meta-analizu Lise Feldman Barrett iz 2019. nad više od 1 000 studija koja pokazuje da facijalni izraz ne implicira pouzdano emociju. Platforma mjeri *pokret*, ne emociju. Bez oznaka emocija, bez vrijednosti pouzdanosti, bez vremenskih grafova emocija. Sustav nikada ne govori kliničarki što pacijent osjeća.

  Zadatak: samostalno hostirana platforma za video-konzultacije isključivo unutar EU-a koja na istoj propusnosti pruža mjerljivo bolji signal za kanale koje kliničari zaista koriste — facijalne mikroizraze i tonalitet glasa — nego što to mogu Zoom ili Teams, koja s podacima face-mesha postupa kao s biometrijskim podacima prema članku 9. GDPR-a, i koja izbjegava vrata visokog rizika iz AI Acta.

  Organizacijsko načelo glasi **„Klijent radi, server prosljeđuje"** — ekstrakcija face-mesha, neuronsko poništavanje šuma, ROI enkodiranje i prilagodljiva frekvencija sličica izvode se na klijentu; server je pametni prekidač. CPU servera ostaje ispod 15 % i pri punom opterećenju. Marginalni trošak veće kvalitete je nula. Platforma isporučuje oko 2,5× oštriju regiju lica na istoj ukupnoj bitrate, 96 kbps Opus zvuk (3× Zoomov standard) i kumulativnu **redukciju pohrane od 98 %** u hladnom sloju kroz cijeli niz codec + composite + face-mesh + retencija. €2 190/mjesec spušteno na €45–55/mjesec pri 500 sesija dnevno. Ključevi AES-256-GCM po sesiji iz HashiCorp Vaulta, kripto-uništavanje za pravo na brisanje prema članku 9. GDPR-a u manje od 24 sata — provjereno na razini koju može verificirati ovlašteno tijelo.
