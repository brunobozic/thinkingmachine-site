...
quickRead: |
  **Radili smo u strukturi koju je nabavni tim nametnuo i dodali strukturu koju nije.**
  ...
  Europski tier-1 energetski operator izdao je pedesetredačnu NFR matricu kroz domene kibernetičke sigurnosti, arhitekture podataka, tehničke arhitekture i kontinuiteta poslovanja / DR — predugovorna due diligence za odnos sa softverskim dobavljačem. Dobavljač je imao operativan proizvod i sigurnosni stog izvorno za Azure. Trebao mu je odgovor koji bi preživio strog nabavni pregled, redak po redak, s dokazima, unutar zadanog roka.

  Sam compliance registar vodio se kao jedan red po zahtjevu: status usklađenosti (usklađen / djelomično / neusklađen / poželjno), obrazloženje, izvor/referenca dokaza, potrebna mjera, procjena troška, vremenski okvir.

  Oko toga dodali smo tri artefakta koje izvorni katalog nije tražio. **Deep-dive teških stavki** — sedam redaka koji su trebali više od retka u registru, svaki s vlastitom narativnom stranicom. **Dnevnik verifikacije izvora** koji svaku tvrdnju *usklađeni smo s X* veže za konkretan sastanak, e-mail ili dizajnerski dokument — pretvarajući tvrdnje o usklađenosti u dokazivu provenijenciju. **Sažetak troškovnog utjecaja** koji konsolidira troškovne implikacije svih djelomično i neusklađenih stavki, izvlačeći okidače za ponovno pregovaranje u prvi plan umjesto u sredinu nabavnog procesa.

  Dobavljač je u nabavni pregled ušao s usklađenošću, dokazima i troškovima rupa u istom dokumentu i prešao u komercijalno zatvaranje bez dodatnog kruga NFR-a. Deep-dive je unaprijed odgovorio na pitanja koja bi neprijateljski nabavni pregled postavio — a sažetak troškovnog utjecaja izložio je **okidače za ponovno pregovaranje prije nego što su postali ponovno pregovaranje.**
