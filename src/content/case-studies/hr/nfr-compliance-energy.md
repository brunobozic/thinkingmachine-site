...
1. **Cyber sigurnost** — autentikacija, kontrola pristupa temeljena na ulogama, višefaktorska autentikacija, klasifikacija podataka, enkripcija u prijenosu i u mirovanju, upravljanje ključevima, upravljanje ranjivostima, penetracijsko testiranje, odgovor na incidente, patching, sigurnost mreže, logiranje i nadzor, pregledi pristupa, integracija sa SIEM-om, sprječavanje gubitka podataka, sigurnost backupa, sigurni SDLC, rizik treće strane, GDPR / privatnost, kontinuitet poslovanja, sigurnosna obuka, izvještavanje o sukladnosti.
