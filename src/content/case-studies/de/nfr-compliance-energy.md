...
1. **Cyber-Sicherheit** — Authentifizierung, rollenbasierte Zugriffskontrolle, Multi-Faktor-Authentifizierung, Datenklassifizierung, Verschlüsselung in Transit und im Ruhezustand, Schlüssel-Management, Vulnerability-Management, Penetrationstests, Incident-Response, Patching, Netzwerksicherheit, Logging und Monitoring, Zugriffs-Reviews, SIEM-Integration, Data-Loss-Prevention, Backup-Sicherheit, sichere SDLC, Drittparteien-Risiko, DSGVO / Privacy, Business Continuity, Sicherheits-Training, Compliance-Reporting.
