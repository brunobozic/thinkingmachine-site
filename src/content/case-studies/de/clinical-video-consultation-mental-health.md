...
quickRead: |
  **Die prägende Entscheidung dieses Mandats war eine Weigerung.** Der EU AI Act (Artikel 5 Absatz 1 Buchstabe f) verbietet Emotionserkennung am Arbeitsplatz und im Bildungsbereich, lässt sie für medizinische Zwecke jedoch ausdrücklich zu. Wir haben uns gegen die medizinische Ausnahme entschieden — gestützt auf Lisa Feldman Barretts Meta-Analyse von 2019 über 1 000+ Studien, die zeigt, dass mimischer Ausdruck Emotionen nicht zuverlässig abbildet. Die Plattform misst *Bewegung*, keine Emotion. Keine Emotionslabels, keine Konfidenzwerte, keine zeitlichen Emotionsverläufe. Das System sagt einer Klinikerin nie, was eine Patientin fühlt.

  Der Auftrag: eine selbst gehostete, ausschließlich in der EU betriebene Video-Konsultationsplattform, die für die Kanäle, auf die Klinikerinnen tatsächlich achten — mimische Mikroausdrücke und Stimmtonalität — bei gleicher Bandbreite messbar mehr Signal liefert als Zoom oder Teams, Face-Mesh-Daten als die biometrischen Daten nach Artikel 9 DSGVO behandelt, die sie sind, und das Hochrisiko-Tor des AI Act umgeht.

  Das Strukturprinzip lautet **„Der Client arbeitet, der Server leitet weiter"** — Face-Mesh-Extraktion, neuronale Rauschunterdrückung, ROI-Encoding und adaptive Bildrate laufen alle auf dem Endgerät; der Server ist ein intelligenter Switch. Die Server-CPU bleibt selbst bei Vollauslastung unter 15 %. Die Grenzkosten höherer Qualität sind null. Die Plattform liefert bei gleicher Gesamtbitrate eine etwa 2,5× schärfere Gesichtsregion, 96 kbps Opus-Audio (3× Zooms Standard) und eine kumulierte **98 %-Speicherreduktion** im Cold-Tier über die gesamte Codec-, Composite-, Face-Mesh- und Retention-Pipeline. €2 190/Monat reduziert auf €45–55/Monat bei 500 Sitzungen pro Tag. Pro-Sitzungs-AES-256-GCM-Schlüssel aus HashiCorp Vault, Crypto-Shredding für das Recht auf Löschung nach Artikel 9 DSGVO in unter 24 Stunden — geprüft auf einem Niveau, das eine benannte Stelle nachvollziehen kann.
